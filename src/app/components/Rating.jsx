...
const Rating = () => {
    ...
    return (
        <div className="bg-white dark:bg-black py-10 mx-8 sm:mx-7.5 md:mx-14">
          ...
          bg-[#434343] dark:bg-white dark:text-black text-white rounded-lg w-full max-w-sm h-60 sm:h-72 md:h-72 lg:h-70 xl:h-60
 ...
 mt-3
  ...
  `}
                            ...
                            <p className=" text-[0.9rem] sm:text-[0.95rem] md:text-[1rem] lg:text-[0.95rem] xl:text-[1.1rem] mt-2 mb-4">{card.text}</p>
                            ...
                            <label className="flex flex-row mt-auto mb-3 gap-3 items-center cursor-pointer">
                                ...
                                <span className="text-[#ffdba2] dark:text-black text-[0.84rem] sm:text-[0.74rem] md:text-[0.87rem] lg:text-[0.77rem] xl:text-[1rem]">
                                    {card.select}
                                </span>
                            </label>
                        </div>
